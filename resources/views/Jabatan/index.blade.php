            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                      ...
                      Anda Tidak Meiliki Hak Akses , Anda Harus Login/Registrasi Terlebih Dahulu! </font></h2>
                    </div>
                    @else
                  
                    <div class="intro-text">
                          <h2><font face="Maiandra GD" color="white">Jabatan <font></h2>
                        <hr class="star-light">

                        <h2><font face="Maiandra GD" color="white">hai <b>{{ Auth::user()->name }}</b> , Anda Memilih jabatan<font></h2>
