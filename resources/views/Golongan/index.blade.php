                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                     <h3><font face="Maiandra GD" color="white">PENGGAJIAN</font></h3>
                        <hr class="star-light">
                         <h2><font face="Maiandra GD" color="white">hai <b>{{ Auth::user()->name }}</b> , Anda Memilih Penggajian</font></h2></div>
                    </div>
                    @endif
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                 <h2><font face="Maiandra GD" color="white"><center>Data Golongan</center></font></h2>
                 <hr>
                  <div class="x_content">
